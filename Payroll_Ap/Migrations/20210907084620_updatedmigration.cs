        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    advance = table.Column<float>(type: "real", nullable: true),
                    tax = table.Column<float>(type: "real", nullable: true),
                    pension18 = table.Column<float>(type: "real", nullable: false),
                    saving = table.Column<float>(type: "real", nullable: true),
                    guard = table.Column<float>(type: "real", nullable: true),
                    others = table.Column<float>(type: "real", nullable: true),
                    ourt = table.Column<float>(type: "real", nullable: true),
                    totalDeduction = table.Column<float>(type: "real", nullable: true),
                    annualization = table.Column<float>(type: "real", nullable: true),
                    allowance = table.Column<float>(type: "real", nullable: true),
                    houseAllowance = table.Column<float>(type: "real", nullable: true),
                    gross = table.Column<float>(type: "real", nullable: true),
                    pension11 = table.Column<float>(type: "real", nullable: true),
                    totalEarning = table.Column<float>(type: "real", nullable: true),
